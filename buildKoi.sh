rm -rf KOI*-*-*.tgz KOI*-*-*.zip .sconsign.dblite dist build build/f7-firmware-C/resources/apps build/f7-firmware-C/resources/nfc/RMProTrainedAmiibo
git pull
DATE_VAR=`date +%m%d`
TIME_VAR=`date +%H%M`
...
# ./fbt updater_package
# mv dist/f7-C/f7-update-Koi420FAP "KOI$DATE_VAR-$TIME_VAR"
# zip -rq "KOI$DATE_VAR-$TIME_VAR-$VER_VAR-$HASH_VAR.zip" "KOI$DATE_VAR-$TIME_VAR"
# tar -czf "KOI$DATE_VAR-$TIME_VAR-$VER_VAR-$HASH_VAR.tgz" "KOI$DATE_VAR-$TIME_VAR"
...
tar -czf "../../../KOI$DATE_VAR-$TIME_VAR/resources.tar.gz" *
cd ../../../
zip -rq "KOI$DATE_VAR-$TIME_VAR-$VER_VAR-$HASH_VAR.zip" "KOI$DATE_VAR-$TIME_VAR"
tar -czf "KOI$DATE_VAR-$TIME_VAR-$VER_VAR-$HASH_VAR.tgz" "KOI$DATE_VAR-$TIME_VAR"
rm -rf "KOI$DATE_VAR-$TIME_VAR"
rm -rf assets/dolphin/internal/*
git stash
echo "BUILD COMPLETED, ZIP AND TGZ GENERATED FOR KOI$DATE_VAR-$TIME_VAR-$VER_VAR-$HASH_VAR"
